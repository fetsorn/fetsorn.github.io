...
Sometimes you see a value and want to search all records that have it. To skip manually pasting the value in the search bar, confirm a `Search cognate?` dialogue near the value.
